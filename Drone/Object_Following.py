# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 02:55:45 2023
...
cv2.createTrackbar("HUE Min","HSV",80,300,empty)
cv2.createTrackbar("HUE Max","HSV",135,300,empty)
...
cv2.createTrackbar("Area","Parameters",8000,30000,empty)
