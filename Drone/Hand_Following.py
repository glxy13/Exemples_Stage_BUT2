# -*- coding: utf-8 -*-
"""
Created on Tue Jan 31 23:56:42 2023
...
# 0 = enable the drone to fly, else 1 (Ex: for camera test)
startCounter = 0
...
cv2.createTrackbar("HUE Max","HSV",16,255,empty)
cv2.createTrackbar("SAT Min","HSV",65,255,empty)
cv2.createTrackbar("SAT Max","HSV",255,255,empty)
cv2.createTrackbar("VALUE Min","HSV",125,255,empty)
...
cv2.createTrackbar("Area","Parameters",3600,35000,empty)
...
def getContours(img,imgContour):
    ...
    for cnt in contours:
        ...
        elif area > areaMin and area < 35000:
...
while True:
    ...
    # Send command to Tello for it to fly
    if startCounter == 0:
        print(drone.get_battery)
        drone.takeoff()
        # time.sleep(3)
